...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'members', name: 'members', component: () => import('@/views/MemberListView.vue'), meta: { title: '会员管理', icon: 'User', roles: ['admin', 'frontdesk'] } },
      ...
      { path: 'bookings', name: 'bookings', component: () => import('@/views/BookingListView.vue'), meta: { title: '预约管理', icon: 'Calendar', roles: ['admin', 'frontdesk', 'trainer', 'member'] } },
